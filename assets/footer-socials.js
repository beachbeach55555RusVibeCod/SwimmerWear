(function(){
  ...
  function render(data){
    ...
    var hasSocials=!!socialSlot.querySelector('a');
    socialSlot.style.display=hasSocials?'flex':'none';
    footer.classList.toggle('footer-has-socials',hasSocials);
    footer.classList.toggle('footer-no-socials',!hasSocials);
  }

  if(!document.getElementById('footer-socials-style')){
    var style=document.createElement('style');
    style.id='footer-socials-style';
    style.textContent='.fbrand{width:160px!important;height:auto!important;max-width:none!important}.footer-spec{grid-template-columns:minmax(230px,1.2fr) minmax(220px,.9fr) minmax(150px,auto) minmax(210px,auto)!important;gap:56px!important;align-items:start!important}.footer-no-socials .footer-spec{grid-template-columns:minmax(230px,1fr) minmax(150px,auto) minmax(210px,auto)!important}.footer-spec__brand,.footer-spec__links,.footer-runtime-contacts{align-self:start}.footer-spec__links{padding-top:2px}.footer-spec__links a{padding:5px 0}.footer-socials-slot{display:flex;justify-content:center;align-items:flex-start;min-height:42px;align-self:start;padding-top:2px}.footer-runtime-contacts{display:flex;flex-direction:column;gap:14px;align-items:flex-start;min-width:210px}.footer-runtime-contacts__data{display:flex;flex-direction:column;gap:10px;font-size:12px;line-height:1.45;color:#cfd4d4}.footer-runtime-contacts__data>div{display:flex;flex-direction:column;gap:3px}.footer-runtime-contacts__data b{font-size:10px;letter-spacing:.08em;color:#7E8688}.footer-runtime-contacts__data a{color:inherit;text-decoration:none;padding:0}.footer-runtime-contacts__data a:hover{text-decoration:underline}.footer-socials{display:flex;gap:12px;align-items:center;justify-content:center;flex-wrap:wrap}.footer-socials a{width:42px;height:42px;border:1px solid rgba(255,255,255,.28);display:grid;place-items:center;color:#fff;text-decoration:none;transition:.18s ease;border-radius:50%;padding:0}.footer-socials a:hover{background:#fff;color:#191d1e;border-color:#fff;transform:translateY(-1px)}.footer-socials svg{width:20px;height:20px;fill:currentColor;stroke:currentColor;stroke-width:1.7}.footer-socials svg rect,.footer-socials svg circle{fill:none}.footer-socials .fill-dot,.footer-socials .play,.footer-socials .phone{fill:currentColor;stroke:none}#brand-contacts .fgrid{grid-template-columns:minmax(230px,1.2fr) minmax(220px,.9fr) minmax(150px,auto) minmax(210px,auto)!important;gap:56px!important;align-items:start!important}.footer-no-socials#brand-contacts .fgrid{grid-template-columns:minmax(230px,1fr) minmax(150px,auto) minmax(210px,auto)!important}.footer-legal,.brand-page-footer-contacts{align-self:start!important;margin-top:0!important}@media(max-width:1000px){.footer-spec,#brand-contacts .fgrid,.footer-no-socials .footer-spec,.footer-no-socials#brand-contacts .fgrid{grid-template-columns:1fr 1fr!important;gap:36px 48px!important}.footer-socials-slot{justify-content:flex-start}.footer-socials{justify-content:flex-start}}@media(max-width:700px){.fbrand{width:140px!important}.footer-spec,#brand-contacts .fgrid,.footer-no-socials .footer-spec,.footer-no-socials#brand-contacts .fgrid{grid-template-columns:1fr!important;gap:26px!important}.footer-runtime-contacts{min-width:0}.footer-socials-slot{min-height:0;justify-content:flex-start;padding-top:0}.footer-socials{justify-content:flex-start}}';
